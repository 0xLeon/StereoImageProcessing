...
t0 = time.perf_counter()
sphere = PLYObject.generate_sphere(sphereInfo)
t1 = time.perf_counter()
print('Took {:.4f} s'.format(t1 - t0))
...
t0 = time.perf_counter()
plane = PLYObject.generate_plane(planeInfo)
t1 = time.perf_counter()
print('Took {:.4f} s'.format(t1 - t0))
...
print('Generating geosphere vertices')
t0 = time.perf_counter()
geosphere = PLYObject.generate_geosphere(sphereInfo, 7)
t1 = time.perf_counter()
print('Took {:.4f} s'.format(t1 - t0))
print('Number of vertices: {:d}'.format(geosphere.getVertices().shape[1]))
print('Writing generated geosphere vertices')
geosphere.write('geosphere_generated.ply')
